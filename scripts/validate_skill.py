"""
Validate the vulcan-curl LuaSkill repository against strict package rules.
校验 vulcan-curl LuaSkill 仓库是否满足严格包结构规则。
"""
...
"""
Validate the dependency manifest used by the vulcan-curl package.
校验 vulcan-curl 包使用的依赖清单。
"""
