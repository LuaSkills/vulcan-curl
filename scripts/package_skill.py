...
def normalize_base_url(base_url: str | None, version: str) -> str:
    if base_url is None or not base_url.strip():
        return f"https://github.com/LuaSkills/vulcan-curl/releases/download/v{version}"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--base-url",
        default=None,
        help="Optional base URL used to build generated source metadata; defaults to the LuaSkills/vulcan-curl GitHub release URL.",
    )
    parser.add_argument(
        "--emit-source-yaml",
        action="store_true",
